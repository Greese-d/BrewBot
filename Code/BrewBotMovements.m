    ...
    methods (Static)
        ...
        function q2Waypoints = GrabCup()
            q2Waypoints = [
                        ...
                        deg2rad([10, 35.2, -85.2, -93.6, 180, -40]); % Grab cup position    
            ];
        end
        
        function q2Waypoints = PlaceCupatMachine()
            q2Waypoints = [
                        deg2rad([10, 35.2, -85.2, -93.6, 180, -40])
        ...
        function q2Waypoints = ReturnCup()
            q2Waypoints = [
                        ...
                        deg2rad([-7.2, -11.2, 7.2, -93.6, 180, 0]);  % Place cup back
            ];
        end
        ...
        function q2Waypoints = PickUpJug()
            q2Waypoints = [
                        ...
                        deg2rad([151, -64.8, 93.4, -86.2, 0, -3]);  % Pour    
            ];
        end
        ...
        function q2Waypoints = GrabLid()
            q2Waypoints = [
                    ...
                    deg2rad([5, 28.8, -50.4, -57.6, 86.4, 0]);  % Place lid
            ];
        end
