classdef BrewbotMovements
    ...
    methods
        ...
        function latteCreate(obj, hObject)
            ...
            obj.moveRobot(hObject, nova2Waypoints, ur3eWaypoints, obj.milkJug, obj.cup);
        ...
        function moveRobot(obj, hObject, nova2Waypoints, ur3eWaypoints, nova2MovedObject,ur3eMovedObject)
            ...
            for i = 1:steps
                ...
                if i <= size(nova2QMatrix, 1)
                    ...
                    if ~isempty(nova2MovedObject)
                        obj.moveObjects(nova2MovedObject, nova2QMatrix(i, :), obj.nova2);
                    end
                ...
                if i <= size(ur3eQMatrix, 1)
                    ...
                    if ~isempty(ur3eMovedObject) 
                        obj.moveObjects(ur3eMovedObject, ur3eQMatrix(i, :), obj.ur3e);
                    end
