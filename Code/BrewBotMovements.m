classdef BrewBotMovements
    ...
    methods
        ...
        function moveRobot(obj, hObject, nova2Waypoints, nova2MovedObject, nova2Vertices, ur3eWaypoints, ur3eMovedObject, ur3eVertices)
            ...
            for i = 1:steps
                ...
                if obj.checkCollision()
                    error("Collision:Triggered", "Emergency stop activated, exiting function hierarchy.");
                end
        ...
        function isCollision = checkCollision(obj)
            % Check if robots are within any bounding boxes
            ...
            for j = 1:size(obj.boundingBoxes, 1)
                ...
                % Check if Nova2 or UR3e is inside the bounding box
