classdef BrewbotTestMovements
        ...
        function ProcessOrders(obj, hObject)
            ...
            while ~isempty(orders)
                ...
                switch order
                    ...
                    case "Latte"
                        disp("Here should be function for making Latte")
                        pause(5)
    ...
    function MoveObjects(obj, object_h, qCurrent, robot)
            tr = robot.model.fkine(qCurrent); 
            vertices = get(object_h, 'Vertices'); 
            transformedVertices = [vertices, ones(size(vertices, 1), 1)] * tr.T;
            set(object_h, 'Vertices', transformedVertices(:, 1:3));  
        end
        ...
        function latte_test(obj, hObject)
            ...
            for i = 1:steps
                ...
                if i <= size(qMatrix1, 1)
                    ...
                    MoveObjects(obj, obj.cup1, qMatrix1(i, :), obj.nova2);
